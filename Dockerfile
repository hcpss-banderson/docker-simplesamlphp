...
RUN set -xe \
	...
	&& rm -rf /var/cache/apk/* \
	&& wget https://simplesamlphp.org/res/downloads/simplesamlphp-${SAML_VERSION}.tar.gz \
	...
	&& wget https://github.com/bander2/twit/releases/download/1.0.0/twit-linux-amd64 \
